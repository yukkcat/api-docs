...
[GitHub repository](https://github.com/yukkcat/gemini-business2api) · **Current stable release: v0.3.3** · [Release Notes](https://github.com/yukkcat/gemini-business2api/releases/tag/v0.3.3) · [All Releases](https://github.com/yukkcat/gemini-business2api/releases)

> **Important:** Since `v0.3.0`, the repository mainline has been fully narrowed into a **2API-focused mainline**. Only **the 2API main service**, **the admin panel**, and **the optional refresh-worker** remain.
>
> The legacy registration tool, registration flow, built-in refresh executor, and browser-display-dependent old paths have been removed or moved out. If you need refresh capability, attach the standalone `refresh-worker` branch or image on demand.
...
> `--with-refresh` only presets the default answer for enabling refresh-worker. It does not represent a separate installation flow.
...
This project uses the **Cooperative Non-Commercial License (CNC-1.0)**. See the complete [LICENSE](https://github.com/yukkcat/gemini-business2api/blob/main/LICENSE).

## Support the Project

If this project helps you, please give it a Star on [GitHub](https://github.com/yukkcat/gemini-business2api).
